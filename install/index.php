                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    ...
                                                    <br><br>
                                                    If you see "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.net/problems-solutions?content=120" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="https://bit.ly/2QCCRlD" target="_blank" class="btn btn-success btn-custom">NULLED</a>
                                            </div>
                                            <div class="form-group text-center">
                                                <strong style="font-size: 600;"><a href="https://www.youtube.com/watch?v=Qbwbkb8WmrA" target="_blank">Watch the installation video</a></strong>
                                            </div>
                                            <div class="form-group">
