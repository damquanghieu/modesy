                                    ...
                                    <table class="table">
                                        ...
                                        <tr style="font-size: 15px;">
                                            ...
                                            <?php if ($this->payment_settings->currency_symbol_format == "left"): ?>
                                                <td><?= get_currency_sign($transaction->currency); ?><?= $transaction->payment_amount; ?></td>
                                            <?php else: ?>
                                                <td><?= $transaction->payment_amount; ?><?= get_currency_sign($transaction->currency); ?></td>
                                            <?php endif; ?>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="order-total float-right">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6 col-right">
                                            <?php if ($this->payment_settings->currency_symbol_format == "left"): ?>
                                                <strong class="font-600"><?= get_currency_sign($transaction->currency); ?><?= $transaction->payment_amount; ?></strong>
                                            <?php else: ?>
                                                <strong class="font-600"><?= $transaction->payment_amount; ?><?= get_currency_sign($transaction->currency); ?></strong>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
