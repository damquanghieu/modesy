                                                                    ...
                                                                    if (!empty($third_categories)):
                                                                        ...
                                                                        <ul>
                                                                            <?php foreach ($third_categories as $third_category):
                                                                                ...
                                                                                <li><a id="nav_main_category_<?= $third_category->id; ?>" href="<?php echo generate_category_url($third_category); ?>" class="nav-main-category <?= ($display_limit > $menu_subcategory_display_limit) ? 'hidden' : ''; ?>" data-id="<?= $third_category->id; ?>" data-parent-id="<?= $third_category->parent_id; ?>" data-has-sb="<?= !empty($third_category->has_subcategory) ? '1' : '0'; ?>"><?= category_name($third_category); ?></a></li>
                                                                                <?php $display_limit++;
                                                                                ...
                                                                                if (!empty($fourth_categories)):
                                                                                    foreach ($fourth_categories as $fourth_category):?>
                                                                                        <li><a id="nav_main_category_<?= $fourth_category->id; ?>" href="<?php echo generate_category_url($fourth_category); ?>" class="nav-main-category hidden" data-id="<?= $fourth_category->id; ?>" data-parent-id="<?= $fourth_category->parent_id; ?>" data-has-sb="0"><?php echo category_name($fourth_category); ?></a></li>
                                                                                    <?php endforeach;
                                                                                endif;
                                                                            endforeach; ?>
