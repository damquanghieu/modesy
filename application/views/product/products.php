                ...
                <div class="product-sort-by">
                    ...
                    <div class="sort-select">
                        <select class="custom-select" onchange="window.location.replace(this.value);">
                            <option value="<?= current_url() . generate_filter_url($query_string_array, 'sort', 'most_recent'); ?>"<?= $filter_sort == 'most_recent' ? ' selected' : ''; ?>><?= trans("most_recent"); ?></option>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 col-sidebar-products">
                <div id="collapseFilters" class="product-filters">
                    <?php $categories = $this->parent_categories;
                    if (!empty($category)):
                    ...
                    <?php if ($this->general_settings->physical_products_system == 1 && $this->general_settings->digital_products_system == 1): ?>
                        <div class="filter-item">
                            <h4 class="title"><?= trans("product_type"); ?></h4>
                            <div class="filter-list-container">
                                <ul class="filter-list">
                                    <li>
                                        <a href="<?= current_url() . generate_filter_url($query_string_array, 'product_type', 'physical'); ?>">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" <?= is_custom_field_option_selected($query_string_object_array, 'product_type', 'physical') ? 'checked' : ''; ?>>
                                                <label class="custom-control-label"><?= trans("physical"); ?></label>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= current_url() . generate_filter_url($query_string_array, 'product_type', 'digital'); ?>">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" <?= is_custom_field_option_selected($query_string_object_array, 'product_type', 'digital') ? 'checked' : ''; ?>>
                                                <label class="custom-control-label"><?= trans("digital"); ?></label>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            if ($filter->key != 'sort'):
                                ...
                                <?php elseif ($filter->key == "product_type"): ?>
                                    <div class="filter-reset-tag">
                                        ...
                                        <div class="right">
                                            <span class="reset-tag-title"><?= trans("product_type"); ?></span>
                                            <span><?= trans(html_escape($filter->value)); ?></span>
                                        </div>
                                    </div>
