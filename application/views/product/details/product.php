                        ...
                        <div class="product-description">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <?php if ($product->product_type != "digital"): ?>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab_shipping" data-toggle="tab" href="#tab_shipping_content" role="tab" aria-controls="tab_shipping" aria-selected="false" onclick="set_location_iframe();"><?= !empty($product->country_id) ? trans("shipping_location") : trans("shipping"); ?></a>
                                    </li>
                                <?php endif; ?>
                                            ...
                                            <div id="collapse_additional_information_content" class="collapse-description-content collapse" data-parent="#accordion">
                                                <table class="table table-striped table-product-additional-information">
                                                    ...
                                                    <?php foreach ($custom_fields as $custom_field): ?>
                                                        <tr>
                                                            <td class="td-left"><?= get_custom_field_name($custom_field->name_array, $this->selected_lang->id); ?></td>
                                                            <td class="td-right"><?php echo get_custom_field_product_values($custom_field, $product->id, $this->selected_lang->id); ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <a class="card-link collapsed" data-toggle="collapse" href="#collapse_shipping_content" onclick="set_location_iframe();">
                                                    <?= !empty($product->country_id) ? trans("shipping_location") : trans("shipping"); ?><i class="icon-arrow-down"></i><i class="icon-arrow-up"></i>
                                                </a>
                                            </div>
