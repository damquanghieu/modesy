            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <select id="select_listing_type" name="listing_type" class="form-control custom-select" required>
                        <option value="sell_on_site" selected><?= trans('add_product_for_sale'); ?></option>
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo trans("location"); ?>&nbsp;(<?= trans("optional"); ?>)</label>
                    <div class="form-group m-0">
                        <?php $this->load->view("partials/_location", ['countries' => $this->countries, 'country_id' => '', 'state_id' => '', 'city_id' => '', 'map' => false]); ?>
                    </div>
                    <div class="form-group">
                        <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table style="width:100%" class="table table-bordered">
                    ...
                    <tr>
                        <td style="width: 180px;">shipping_time</td>
                        <td><?= trans("data_type"); ?>: Text <br><strong><?= trans("required"); ?></strong><br><?= trans("example"); ?>: 2_3_business_days<br><br>
                            <strong class="font-600"><?= trans("options"); ?>:</strong><br>
                            1_business_day<br>
                            2_3_business_days<br>
                            4_7_business_days<br>
                            8_15_business_days<br>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 180px;">shipping_cost_type</td>
                        <td><?= trans("data_type"); ?>: Text <br><strong><?= trans("required"); ?></strong><br><?= trans("example"); ?>: shipping_buyer_pays<br><br>
                            <strong class="font-600"><?= trans("options"); ?>:</strong><br>
                            free_shipping<br>
                            shipping_included<br>
                            shipping_buyer_pays<br>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 180px;">shipping_cost</td>
                        <td><?= trans("data_type"); ?>: Decimal/Number <br><strong><?= trans("required"); ?></strong><br><?= trans("example"); ?>: 5</td>
                    </tr>
                    <tr>
    ...
    $(function () {
        $('#drag-and-drop-zone').dmUploader({
            ...
            onUploadSuccess: function (id, response) {
                ...
                obj_csv.country_id = $("#select_countries").val();
                obj_csv.state_id = $("#select_states").val();
                obj_csv.city_id = $("#select_cities").val();
                obj_csv.address = $("#address_input").val();
                obj_csv.zip_code = $("#zip_code_input").val();
    ...
    function add_csv_item(number_of_items, txt_file_name, index) {
        if (index <= number_of_items) {
            var data = {
                ...
                "country_id": obj_csv.country_id,
                "state_id": obj_csv.state_id,
                "city_id": obj_csv.city_id,
                "address": obj_csv.address,
                "zip_code": obj_csv.zip_code
            };
