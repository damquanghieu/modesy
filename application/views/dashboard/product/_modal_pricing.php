...
<?php $promote_currency = $this->payment_settings->default_currency; ?>
                ...
                <div class="row">
                        ...
                        <div id="pricing_plan_1" class="price-box">
                            ...
                            <div class="plan-price text-center">
                                <?php if ($this->payment_settings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?php echo price_formatted(0, $promote_currency); ?></span><span class="time">/<?= trans("day"); ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?php echo price_formatted($this->payment_settings->price_per_day, $promote_currency); ?></span><span class="time">/<?= trans("day"); ?></span></h3>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="pricing_plan_2" class="price-box">
                            ...
                            <div class="plan-price text-center">
                                <?php if ($this->payment_settings->free_product_promotion == 1): ?>
                                    <h3><span class="price"><?php echo price_formatted(0, $promote_currency); ?></span><span class="time">/<?= trans("month"); ?></span></h3>
                                <?php else: ?>
                                    <h3><span class="price"><?php echo price_formatted($this->payment_settings->price_per_month, $promote_currency); ?></span><span class="time">/<?= trans("month"); ?></span></h3>
                                <?php endif; ?>
                            </div>
                            <div class="price-features">
                                <p>
                    ...
                    <input type="hidden" id="price_per_month" value="<?php echo $price_per_month; ?>">
                        ...
                        <div class="col-sm-12 container-pricing-plan" id="container_pricing_plan_1">
                            ...
                            <div class="form-group">
                                <?php if ($this->payment_settings->currency_symbol_format == "left"): ?>
                                    <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<?php echo get_currency($promote_currency); ?><span class="span-price-total-daily"><?php echo $price_per_day; ?></span>&nbsp;<?php echo $promote_currency; ?></strong>
                                <?php else: ?>
                                    <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<span class="span-price-total-daily"><?php echo $price_per_day; ?></span><?php echo get_currency($promote_currency); ?>&nbsp;<?php echo $promote_currency; ?></strong>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="col-sm-12 container-pricing-plan" id="container_pricing_plan_2">
                            ...
                            <div class="form-group">
                                <?php if ($this->payment_settings->currency_symbol_format == "left"): ?>
                                    <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<?php echo get_currency($promote_currency); ?><span class="span-price-total-monthly"><?php echo $price_per_month; ?></span>&nbsp;<?php echo $promote_currency; ?></strong>
                                <?php else: ?>
                                    <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<span class="span-price-total-monthly"><?php echo $price_per_month; ?></span><?php echo get_currency($promote_currency); ?>&nbsp;<?php echo $promote_currency; ?></strong>
                                <?php endif; ?>
                            </div>
                            <div class="form-group m-0">
                                <button type="submit" class="btn btn-lg btn-success"><?php echo trans("continue_to_checkout"); ?></button>
