            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="position-relative">
                        <input type="text" name="sku" id="input_sku" class="form-control form-input" value="<?= html_escape($product->sku); ?>" placeholder="<?php echo trans("sku"); ?>&nbsp;(<?php echo trans("optional"); ?>)">
                        ...
                        <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= $this->selected_lang->id == $language->id ? 'in' : ''; ?>">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_keywords_<?= $language->id; ?>" value="<?= !empty($product_details) ? $product_details->seo_keywords : ''; ?>" class="form-control form-input m-b-5" placeholder="<?php echo trans("keywords"); ?> (E.g. book, new, pencil)">
                                </div>
                            </div>
                        </div>
                    </div>
