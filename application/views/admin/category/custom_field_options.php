...
<div class="callout" style="margin-top: 10px;background-color: #fff; border-color:#00c0ef;max-width: 600px;">
    ...
    <p><?php echo trans('field_name'); ?>:&nbsp;<strong><?= get_custom_field_name($field->name_array, $this->selected_lang->id); ?></strong></p>
    <p>
        <?php echo trans('type'); ?>:&nbsp;
        <strong>
                        ...
                        <table class="table table-bordered table-striped" role="grid">
                            ...
                            <?php if (!empty($field_categories)):
                                foreach ($field_categories as $item):
                                    if (!empty($item)):
                                        $categories_tree = get_parent_categories_tree($item->category_id, false);
