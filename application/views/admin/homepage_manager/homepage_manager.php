        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <select id="categories" name="category_id[]" class="form-control" onchange="get_subcategories(this.value, 0,'subcategories_container');" required>
                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php if (!empty($featured_categories)):
                            foreach ($featured_categories as $item):
                                if (!empty($item)):
                                    $categories_tree = get_parent_categories_tree($item->id, false);
                                    if (!empty($categories_tree)):?>
                                        <tr>
                                            <td style="vertical-align: middle">
                                                ...
                                                <input type="number" class="form-control input-featured-categories-order m-r-5 pull-right" value="<?= $item_tree->featured_order; ?>" data-category-id="<?= $item_tree->id; ?>" min="1" max="9999999" placeholder="<?= trans("order"); ?>" style="width: 80px; display: inline-block; height: 24px;">
                                            </td>
                                        </tr>
                                    <?php endif;
                                endif;
    ...
    <div class="col-md-12 col-lg-6">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label"><?php echo trans("category"); ?></label>
                    <select id="categories" name="category_id[]" class="form-control" onchange="get_subcategories(this.value, 0,'subcategories_container_1');" required>
                        <option value=""><?php echo trans('select_category'); ?></option>
                        <?php foreach ($parent_categories as $item): ?>
                            <option value="<?php echo html_escape($item->id); ?>"><?php echo category_name($item); ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div id="subcategories_container_1"></div>
                </div>
                <div class="form-group text-right">
                                    ...
                                    if (!empty($categories_tree)):?>
                                        <tr>
                                            <td>
                                                ...
                                                <input type="number" class="form-control input-index-categories-order m-r-5 pull-right" value="<?= $item_tree->homepage_order; ?>" data-category-id="<?= $item_tree->id; ?>" min="1" max="9999999" placeholder="<?= trans("order"); ?>" style="width: 80px; display: inline-block; height: 24px;">
                                            </td>
                                        </tr>
                                    <?php endif;
                                endif;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table data-page-length="8" class="table table-bordered table-striped dataTable table-no-sort" id="cs_datatable" role="grid">
                                <thead>
                                <tr role="row">
...
<div id="form_settings" class="row">
