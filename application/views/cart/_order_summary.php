...
<div class="col-sm-12 col-lg-5 order-summary-container">
    ...
    <div class="right">
        ...
        <p class="m-t-30">
            <strong><?php echo trans("subtotal"); ?><span class="float-right"><?php echo price_formatted($cart_total->subtotal, $this->payment_settings->default_currency); ?></span></strong>
        </p>
        ...
        <?php if ($is_physical && $this->form_settings->shipping == 1): ?>
            <p>
                <?php echo trans("shipping"); ?><span class="float-right"><?php echo price_formatted($cart_total->shipping_cost, $this->payment_settings->default_currency); ?></span>
            </p>
        <?php endif; ?>
        <p class="line-seperator"></p>
        <p>
            <strong><?php echo trans("total"); ?><span class="float-right"><?php echo price_formatted($cart_total->total, $this->payment_settings->default_currency); ?></span></strong>
        </p>
